    ...
    <div className="flex min-h-screen items-center justify-center bg-stone-50">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Let&apos;s get you set up.</p>
        </div>
        <form onSubmit={handleSubmit} className="rounded-xl border border-stone-100 bg-white p-6 shadow-sm">
          ...
          <p className="mt-4 text-center text-sm text-slate-500">
            ...
            <Link href="/login" className="font-medium text-orange-600 hover:text-orange-700">Sign in</Link>
          </p>
        </form>
      </div>
    </div>
